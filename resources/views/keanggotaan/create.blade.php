            ...
            {{-- <form method="POST" action="{{ route('keanggotaan.store') }}"> --}}
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="add_nik" name="nik">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="add_tempat_lahir" name="tempat_lahir">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="add_tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}">
                        @error('tanggal_lahir')
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" name="jenis_kelamin" id="add_jenis_kelamin" value="{{ old('jenis_kelamin') }}">
                        @error('jenis_kelamin')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" name="pendidikan" id="add_pendidikan" value="{{ old('pendidikan') }}">
                        @error('pendidikan')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="add_alamat" name="alamat" value="{{ old('alamat') }}">
                        @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        </textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_telepon" id="add_no_telepon" class="form-control" required>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" name="status" id="add_status" value="{{ old('status') }}">
                        @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="add_foto" name="foto" value="{{ old('foto') }}">
                        @error('foto')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror" id="add_tanggal_daftar" name="tanggal_daftar" value="{{ old('tanggal_daftar') }}">
